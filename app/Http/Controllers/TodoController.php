...
class TodoController extends Controller
{
    ...
    public function index($id)
    {
        ...
        $task= Task::find($id);
        return view('user.todo.index',compact('todos'))->with('task',$task);
    }
    ...
    {
      $task= Task::find($id);
        return view('user.todo.create',compact('task'));
    }
    ...
    public function edit($id)
    {
      ...
      $task = Task::find($todo->task_id);
        return view('user.todo.edit',compact('task'))->with('todo',$todo);
