                    ...
                    <div class="nk-split nk-split-page nk-split-md">
                        <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                ...
                                <form method="POST" action="{{ route('trainer.login') }}" class="form-validate is-alter" >
                                     @csrf
                                ...
                                <div class="form-note-s2 pt-4"> New on our platform? <a href="trainer/register">Create an account</a>
                                </div>
                                    ...
                                    <div class="slider-item">
                                        <div class="nk-feature nk-feature-center">
                                            <div class="nk-feature-img">
                                                <img class="round" src="{{asset('dash/images/slides/promo-a.png')}}" srcset="./images/slides/promo-a2x.png 2x" alt="">
                                            </div>
