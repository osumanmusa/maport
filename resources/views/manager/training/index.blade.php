            ...
            <div class="breadcrumb row col-lg-12">
                ...
                <div class="col-md-2"></div>
                   <div class="col-md-4" role="group" aria-label="Basic example" style="float: right;justify-content: right;">
                            <a type="button" href="/admin/Training-create/" class="btn btn-raised ripple btn-raised-secondary m-1"> <i class="fa fa-tasks"></i> New</a> 
                          ...
                          <table class="table ">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>{{$training->name}}</td>
                                <td>
                                  <span>{{$training->no_class}} </span>
                                </td>
                                <td>
                                  <span class="p-2 m-1">{{$training->description}}</span>
                                </td>
                                <td>
                                  <span>{{$training->available_slot}} </span>
                                </td>
                                <td>{{$training->total_enrollment}}</td>
                                <td>
                                  <span class=" p-2 m-1">{{$training->tags}}</span>
                                </td>
                                <td>
                                ...
                                <td>
                                  ...
                                  <div class="dropdown-menu" x-placement="bottom-start"
                                    ...
                                    <a class="dropdown-item ul-widget__link--font" href="/admin/TrainingClass-create/{{$training->id}}">
                                      <i class="i-Bar-Chart-4"> </i>
                                      Add Class</a>
                                    <a class="dropdown-item ul-widget__link--font" href="/admin/TrainingClass-list/{{$training->id}}">
