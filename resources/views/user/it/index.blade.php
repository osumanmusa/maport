            ...
            <div class="breadcrumb row col-lg-12">
                ...
                <div class="col-md-2"></div>
                   <div class="col-md-4" role="group" aria-label="Basic example" style="">
                            <a type="button" href="/user/create-regforms" class="btn btn-raised ripple btn-raised-secondary m-1"> <i class="fa fa-tasks"></i> New</a>  
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <div class="dropdown-menu" x-placement="bottom-start"
                                    ...
                                    <a class="dropdown-item ul-widget__link--font" href="{{url('/user/edit-regforms/'.$form->id)}}">
                                      <i class="i-Bar-Chart-4"> </i>
                                      Edit</a>
                                    <a class="dropdown-item ul-widget__link--font" href="{{url('/user/delete-regforms/'.$form->id)}}">
