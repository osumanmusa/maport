            ...
            <div class="breadcrumb row col-lg-12">
                ...
                <div class="col-md-2"></div>
                   <div class="col-md-4" role="group" aria-label="Basic example" style="">
                            <button onclick="window.location.href='{{url('/user/create-todo/'.$task->id)}}'"  class="btn btn-raised ripple btn-raised-secondary m-1"> <i class="fa fa-tasks"></i> New</button>  
                            ...
                            <button onclick="window.location.href='{{ URL::to('/regforms/pdf') }}'" class="btn btn-raised ripple btn-raised-danger m-1"> <i class="fa fa-tasks"></i> PDF</button>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <div class="dropdown-menu" x-placement="bottom-start"
                                    ...
                                    <a class="dropdown-item ul-widget__link--font" href="{{url('/user/edit-todo/'.$todo->id)}}">
                                      <i class="i-Bar-Chart-4"> </i>
                                      Edit</a>
                                    <a class="dropdown-item ul-widget__link--font" href="{{url('/user/delete-todo/'.$todo->id)}}">
