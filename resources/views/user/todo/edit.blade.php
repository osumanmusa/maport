            ...
            <div class="breadcrumb row col-lg-12">
                ...
                <div class="col-md-2"></div>
                   ...
                   <div class="col-md-4" role="group" aria-label="Basic example" style="">
                            <button onclick="window.location.href='{{url('/user/todo/'.$task->id)}}'" class="btn btn-raised ripple btn-raised-info m-1"> <i class="fa fa-tasks"></i> View Todo</button>
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form class="needs-validation" action="{{url('/user/update-todo', [$todo->id])}}" method="post" enctype="multipart/form-data" novalidate>
                                               @csrf
