            ...
            <div class="breadcrumb row col-lg-12">
                ...
                <div class="col-md-2"></div>
                   <div class="col-md-4" role="group" aria-label="Basic example" style="">
                            <a type="button" href="/admin/Event-create" class="btn btn-raised ripple btn-raised-secondary m-1"> <i class="fa fa-tasks"></i> Add New</a> 
                          ...
                          <table class="table ">
                            ...
                            <tbody>
                              ...
                              <tr>
                                  ...
                                  <span>
                                    <div class="ul-widget_user-card">
                                      <div class="ul-widget4__img">
                                        <img src="{{asset('assets/images/uploads/'.$event->banners)}}" id="userDropdown" alt="" />
                                      </div>
                                    </div>
                                  </span>
                                </td>
                                <td>{{$event->name}}</td>
                                <td>
                                  <span class="p-2 m-1">{{$event->description}}</span>
                                </td>
                                <td>
                                ...
                                <td>
                                  <span class=" p-2 m-1">{{$event->event_type}}</span>
                                </td>
                                <td>
